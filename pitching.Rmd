...
The results of the bootstrapping indicates that the regression model is sound, with an R-squared confidence interval between .8016 and .8619, and an R-squared of 0.8248. Thus with the data that is provided the model predicts pitch speed with 80-87% accuracy.
