...
t_plot = ggplot(train_df, aes(x=(thorax_distal_transfer_fp_br), y=log(pitch_speed_mph))) + 
  geom_point() +
  geom_smooth(method = "lm",formula = y ~ poly(x,2), color="blue") +
  labs(
...
s_plot = ggplot(train_df, aes(x=(shoulder_transfer_fp_br), y=log(pitch_speed_mph))) + 
  geom_point() +
  geom_smooth(method = "lm",formula = y ~ poly(x,2), color="blue") +
  labs(
